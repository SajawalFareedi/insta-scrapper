...
const _Proxy = "http://kuetxqpq-rotate:dwcgpcu5fdwv@p.webshare.io:9999";

app.get("/generate-proxy-tunnel", async (req, res, next) => {
  try {
    const StaticProxy = await ProxyChain.anonymizeProxy(Proxy || _Proxy);
